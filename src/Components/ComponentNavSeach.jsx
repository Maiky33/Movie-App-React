...
const ComponentNavSeach = ({ SeachMovie, OpenCloseNav,SendUrl }) => { //pasamos por parametros las funciones que necesittamos en app.js
        ...
        <div className="ContainerNav">
            ...
            <div className="ContainerListNav">
                ...
                <form onSubmit={enviarurl}>  
                    <input placeholder="Seach Movie" className="inputSeach" onChange={buscarpeli}/>
                </form>

                <div className="ContainerItemNav">   
                    <BsFillCaretLeftFill className="CursorPointer" onClick={abrirCerrarmenu}/>
